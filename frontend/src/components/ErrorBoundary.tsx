            ...
            return (
                <div className="flex items-center justify-center p-4 bg-red-950/40 border border-red-800 rounded-lg m-2">
                    <div className="text-center font-mono">
                        <div className="text-red-400 text-xs tracking-widest mb-1">⚠ ERROR DEL SISTEMA</div>
                        <div className="text-[var(--text-secondary)] text-[10px]">{this.props.name || "Componente"} no pudo renderizarse</div>
                        <button
